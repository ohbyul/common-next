  ...
  findContours: (function () {
    ...
    const me = {
      ...
      close: function () {
        ...
        dom.querySelector("#MediautoView").removeChild(me.widget);
      },
      ...
      `;
        ...
        dom.querySelector("#MediautoView").appendChild(me.widget);
      ...
      addRegions: function () {
        ...
        for (const con of me.contourArray) {
          ...
          Mediauto.region = Mediauto.newRegion({ path });
      ...
      click: function click(prevTool) {
        ...
        Mediauto.selectedTool = prevTool;
      }
    };
